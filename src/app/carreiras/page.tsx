    ...
    <section className={`relative lg:py-32 pt-32 pb-20 bg-purple min-h-screen`}>
      ...
      <div className="container z-10 relative">
        <div className="text-white flex flex-col items-center ml-8 sm:ml-0 gap-10 lg:gap-14 mb-12 lg:mb-24">
          ...
          <p className="uppercase font-neulis-bold-italic text-lg lg:text-3xl lg:text-center max-w-[1100px] mx-auto">
            Junte-se ao time de profissionais da maior referência em marketing imobiliário do país.
            {/* <span> Envie seu currículo e portfólio.</span> */}
        ...
        {!error && (
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 lg:gap-5 max-w-[900px] mx-auto font-neulis-medium">
            ...
            <input type="hidden" name="from_name" value="agencianewe.com.br - carreiras" />
