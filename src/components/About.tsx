        ...
        <div className="flex flex-col lg:flex-row items-start justify-around gap-20">
          <div className="flex flex-col gap-12 lg:max-w-[590px]">
            ...
            <div className="uppercase">
              <p className="lg:text-4xl font-neulis-semi-bold-italic">Thaisa Eugenio</p>
              <p className="lg:text-3xl font-neulis-light-italic">Diretora executiva</p>
            </div>
          ...
          <div className="flex flex-col gap-12 lg:max-w-[590px] relative">
            ...
            <div className="uppercase">
              <p className="lg:text-4xl font-neulis-semi-bold-italic">Luisa Eugenio</p>
              <p className="lg:text-3xl font-neulis-light-italic">Head de criação e planejamento</p>
            </div>
