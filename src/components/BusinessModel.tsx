...
export default function BusinessModel({className}: {className?: string}) {
  return (
    <section className={`${className} relative pt-[380px] pb-20 lg:pt-[500px] lg:pb-32`}>
      ...
      <Image src={"/images/planetas-novo.png"} alt="planetas" width={511} height={511} className="absolute top-20 left-0 lg:left-[28vw] mx-auto px-10 lg:px-0 z-10" data-aos="fade-down" data-aos-delay="300" />
