        ...
        <div className="flex flex-col text-white items-center gap-20 2xl:px-48">
          ...
          <div className="relative w-full swiper-cards">
            ...
            >
              {cards.map((card) => (
                <SwiperSlide key={card.title}>
                  <div className="bg-purpleDark rounded-[24px] aspect-[410/475] min-w-[410px] h-[475px] shadow-lg py-14 px-10 flex flex-col justify-center items-center gap-14">
                    <h3 className="lg:text-4xl uppercase font-neulis-bold-italic text-center hashtag">
            ...
            <div className="absolute w-full flex justify-between top-1/2 -translate-y-[50%] z-20">
              <button className="swiper-button-prev-card relative cursor-pointer lg:text-3xl rotate-180 disabled:opacity-0">
                <svg 
              ...
              <button className="swiper-button-next-card relative cursor-pointer lg:text-3xl lg:left-8 disabled:opacity-0">
                <svg 
                  xmlns="http://www.w3.org/2000/svg"
                  width="20px" height="36px">
                  <path fillRule="evenodd"  fill="rgb(175, 152, 191)"
