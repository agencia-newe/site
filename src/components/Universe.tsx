        ...
        <SwiperSlide>
          <section className={` relative h-screen w-full bg-purple overflow-hidden rounded-3xl lg:rounded-[42px]`} data-aos="fade-up">
            ...
            <div className="container text-white inset-0 w-full h-full flex flex-col justify-center items-start" data-aos="fade-right" data-aos-delay="500">
              ...
              <button className="swiper-button-next-parent cursor-pointer bg-purpleLight text-purpleDark font-neulis-semi-bold-italic uppercase mt-12 pb-2.5 pt-3 px-10 rounded-2xl hover:bg-purple hover:text-white !transition-all !duration-300">
                Clique aqui
              </button>
            </div>
          </section>
            ...
            <div className="text-white inset-0 w-full h-full">
              <div className="w-full h-full relative">
                ...
                <div className="absolute w-full flex justify-between top-1/2 -translate-y-[50%] z-20">
                  <button className="swiper-button-prev-child relative cursor-pointer lg:text-3xl lg:left-12 rotate-180 disabled:opacity-0" title="Anterior">
                    <svg 
                  ...
                  <button className="swiper-button-next-child relative cursor-pointer lg:text-3xl lg:right-12 disabled:opacity-0" title="Próximo">
                    <svg 
                      xmlns="http://www.w3.org/2000/svg"
                      width="20px" height="36px">
                      <path fillRule="evenodd"  fill="rgb(175, 152, 191)"
